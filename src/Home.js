...
export const Home = () => {
    return (
        <>
          ...
          {/* Learn More
          <br/>
          <Link className="btn btn-outline-light btn-lg" to="/about">About Me</Link> */}
        </p>
            </div>
            <div className="container-desc text-white text-center">
          <br/>
          {/* <h1>I have Done Couple of Projects</h1>
           <br/><Link className="btn btn-outline-light btn-lg" to="/work">See My Project</Link> */}
           <br/>
           <br/>
            </div>
            ...
            <div className="social row row-cols-1 row-cols-md-2 row-cols-lg-2 g-2">
                <div className="col">
                    ...
                    <div className="card-body text-white text-center"><br/>
                        <Link className="btn btn-outline-light btn-lg" to="/work">Click Here</Link>
                    </div>
                    </div>
            ...
            <div className="social row row-cols-1 row-cols-md-3 row-cols-lg-4 g-2">
                <div className="col">
                    ...
                    <div className="card-body text-white text-center">
                        <h4>OR</h4><br/>
                        <Link className="btn btn-outline-light btn-lg" target="_blank" to="/facebook">Click Here</Link>
                    </div>
                    </div>
                ...
                <div className="col">
                    ...
                    <div className="card-body text-white text-center">
                        <h4>OR</h4><br/>
                        <Link className="btn btn-outline-light btn-lg" target="_blank" to="/instagram">Click Here</Link>
                    </div>
                    </div>
                </div>
                <div className="col">
                    ...
                    <div className="card-body text-white text-center">
                        <h4>OR</h4><br/>
                        <Link className="btn btn-outline-light btn-lg" target="_blank" to="/snapchat">Click Here</Link>
                    </div>
                    </div>
                </div>
                <div className="col">
                    ...
                    <div className="card-body text-white text-center">
                        <h4>OR</h4><br/>
                        <Link className="btn btn-outline-light btn-lg" target="_blank" to="/linkedin">Click Here</Link>
                    </div>
                    </div>
                </div>
            </div>
