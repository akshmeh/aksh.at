  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div className="d-flex">
        <Link className="btn btn-secondary cont-btn" to="/aksh.at/contact">Contact  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" className="bi bi-telephone-outbound" viewBox="0 0 16 16">
